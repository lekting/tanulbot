...
// Learning language selection values
export const LEARNING_HUNGARIAN = 'Hungarian';
export const LEARNING_SPANISH = 'Spanish';
export const LEARNING_FRENCH = 'French';
export const LEARNING_GERMAN = 'German';
export const LEARNING_ITALIAN = 'Italian';
